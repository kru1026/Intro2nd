      ...
      >
        ...
        <section>
          <Link href="/education" style={{ textDecoration: "none" }}>
            <h2 style={{ marginBottom: "15px", marginTop: "15px" }}>Education</h2>
          </Link>
        </section>
        <hr />
        ...
        <section>
          <Link href="/messageForm" style={{ textDecoration: "none" }}>
            <h2 style={{ marginBottom: "15px", marginTop: "15px" }}>Leave a Message</h2>
          </Link>
        </section>
        <hr />
